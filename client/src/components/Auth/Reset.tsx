    ...
    return (
            <div className="flex items-center flex-col justify-center w-screen h-screen md:w-[60%] lg:w-[35%] xl:w-[25%]">
                ...
                <label className="text-[1em] font-semibold py-[5px]" htmlFor="password">Hasło</label>
                    ...
                    <input className="px-[10px] py-[10px] border-[1px] border-cyan-700" id="confirmPassword" type="confirmPassword" placeholder="Powtórz nowe hasło" onChange={(e)=>{setConfirmPassword(e.target.value)}} value={confirmPassword} />

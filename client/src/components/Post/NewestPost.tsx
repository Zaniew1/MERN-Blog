    ...
    return (
        <article className=" flex flex-col w-[95%] mx-auto   pb-[25px] mt-[100px] border-b border-solid border-slate-300 z-10 md:flex-row md:border-none lg:flex-grow lg:mx-[15px]">
            <div className="w-full md:w-[50%] lg:flex-col lg:flex lg:justify-center mr-[15px]">
                ...
                <h3 className="text-[2.3em] font-bold cursor-pointer transition ease-in-out text-[#2C3241] leading-tight md:mb-[25px] md:text-[3.4em] md:leading-[1.1em] hover:text-sky-700">Best easy Recipes for Breakfast Menus</h3>
            ...
            <div className="w-full aspect-square cursor-pointer border bg-duck-picture bg-center bg-cover md:w-[50%] my-auto lg:ml-[15px] ">
            </div>
        </article>
    )
}
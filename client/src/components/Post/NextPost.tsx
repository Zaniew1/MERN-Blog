...
export const NextPost:React.FC<NextPostType> = (props):JSX.Element => {
    ...
    return(
            <article className={`flex flex-col w-[95%] mx-auto z-10 border-b border-solid border-slate-300 md:mx-[15px] md:border-none md:mb-[40px] ${+props.index > 2 ? "md:w-[25%]" : "md:w-[45%]"} ${+props.index >= +showMorePostsIndex ? "hidden" : ""} md:flex-grow `}>

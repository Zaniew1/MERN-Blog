...
export const NextPost:React.FC<NextPostType> = (props):JSX.Element => {
    return(
        <article className={`mt-[20px] mx-[15px] z-10 border-b border-solid border-slate-300 md:border-none md:mb-[60px] ${props.index > 2 ? "lg:w-[25%]" : "lg:w-[45%]"} lg:flex-grow `}>
            <div className={`w-full h-[200px] border bg-duck-picture bg-center cursor-pointer bg-cover md:aspect-video md:h-auto ${props.index > 2 ? "lg:aspect-video" : "lg:h-[300px]"}`}> </div>
            <p className="tracking-wide font-bold text-[1.2em] py-[15px] text-[#2C3241] md:text-[1em] ">Dziedzina</p>
            <h3 className="text-[1.6em] cursor-pointer font-bold text-[#2C3241] md:text-[1.8em] md:font-semibold hover:text-sky-700">Lorem ipsum some headerasdasd aslkdj lksd</h3>
